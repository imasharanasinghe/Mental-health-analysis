...
def main():
    ...
    X = df.drop(columns=[COLUMNS.target_severity, COLUMNS.target_stress, COLUMNS.target_condition], errors="ignore")
    y = df[COLUMNS.target_severity]
    ...
    # Save model + encoder
    joblib.dump(grid.best_estimator_, "models/severity_model.pkl")
    joblib.dump(le, "models/severity_encoder.pkl")
    print("💾 Model saved to models/severity_model.pkl")
    print("💾 Encoder saved to models/severity_encoder.pkl")
